...
const videoTasks = [
  {
    ...
    description: "Watch a 30-second product ad",
    points: 100,
    duration: "30s",
  ...
  },
  {
    ...
    description: "New game release trailer",
    points: 150,
    duration: "1m",
  ...
  },
  {
    id: 3,
    title: "App Tutorial",
    description: "Learn how to use new features",
    points: 200,
    duration: "2m",
  ...
  },
  {
    id: 5,
    title: "Movie Trailer",
    description: "Upcoming blockbuster preview",
    points: 300,
    duration: "2m",
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 bg-white dark:bg-slate-800 rounded-xl shadow-card dark:shadow-none dark:border dark:border-slate-700 p-4">
              ...
              <p className="text-2xl font-bold text-primary-600 dark:text-primary-400">
                {completedTasks.length}/{videoTasks.length}
              </p>
            </div>
          </div>
            ...
            {videoTasks.map((task) => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-white dark:bg-slate-800 rounded-xl shadow-card dark:shadow-none dark:border dark:border-slate-700 overflow-hidden hover:shadow-soft transition-all ${
                    isCompleted ? "opacity-75" : ""
                  }`}
                >
                  {/* Thumbnail */}
                  <div
                    className={`h-40 ${task.thumbnail} relative flex items-center justify-center`}
                  >

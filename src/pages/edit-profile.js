...
import { AiOutlineArrowLeft, AiOutlineCamera, AiOutlineUser, AiOutlineMail, AiOutlinePhone } from 'react-icons/ai';
      ...
      <Layout title="Edit Profile">
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-card p-8 text-center">
            ...
            <p className="text-slate-500 mt-4">Tap the camera to change photo</p>
          </div>
          ...
          <div className="flex gap-4">
            <Link 
              href="/profile"
              className="flex-1 py-4 bg-slate-200 text-slate-700 font-semibold rounded-xl hover:bg-slate-300 transition-colors text-center"
            >
              Cancel
            </Link>
            <button 

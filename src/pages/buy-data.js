...
import { AiOutlineArrowLeft, AiOutlinePhone, AiOutlineCheck } from 'react-icons/ai';
      ...
      <Layout title="Buy Data">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-800">Buy Data</h2>
              <p className="text-slate-500">Purchase mobile data bundles</p>
            </div>
          </div>
          ...
          {selectedNetwork && (
            ...
            >
              <h3 className="font-semibold text-slate-800 mb-4">Select Data Plan</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {dataPlans.map((plan) => (
                  ...
                  >
                    <p className="text-2xl font-bold text-slate-800">{plan.name}</p>
                    <p className="text-sm text-slate-500">{plan.validity}</p>
                    <p className="text-lg font-bold text-primary-600 mt-2">₦{plan.price}</p>
                  </button>
                ))}
              </div>
            </motion.div>

          ...
          <div className="grid gap-4">
            {supportOptions.map((option) => (
              <motion.button
                ...
                className="flex items-center gap-4 bg-white dark:bg-slate-800 rounded-xl shadow-card dark:shadow-none dark:border dark:border-slate-700 p-4 hover:shadow-soft transition-all text-left"
              >
                <div
                  className={`w-14 h-14 ${option.color} rounded-xl flex items-center justify-center`}
                >
                ...
                <AiOutlineArrowLeft className="w-5 h-5 text-slate-400 dark:text-slate-500 rotate-180" />
              </motion.button>
            ))}
          </div>
